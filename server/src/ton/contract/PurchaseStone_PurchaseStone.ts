...
export function storeStonePurchasedNotification(
  src: StonePurchasedNotification,
) {
  return (builder: Builder) => {
    const b_0 = builder;
    b_0.storeUint(1, 32);
...
export function loadStonePurchasedNotification(slice: Slice) {
  ...
  return {
    $$type: 'StonePurchasedNotification' as const,
    user: _user,
    amount: _amount,
...
export function storeTupleStonePurchasedNotification(
  source: StonePurchasedNotification,
) {
  const builder = new TupleBuilder();
...
export function dictValueParserStonePurchasedNotification(): DictionaryValue<StonePurchasedNotification> {
  return {
    serialize: (src, builder) => {
      builder.storeRef(
        beginCell().store(storeStonePurchasedNotification(src)).endCell(),
      );
    },
    parse: (src) => {
...
export function loadPurchaseStone$Data(slice: Slice) {
  ...
  return {
    $$type: 'PurchaseStone$Data' as const,
    owner: _owner,
    uniqueId: _uniqueId,
  };
}
...
export function dictValueParserPurchaseStone$Data(): DictionaryValue<PurchaseStone$Data> {
  return {
    serialize: (src, builder) => {
      builder.storeRef(
        beginCell().store(storePurchaseStone$Data(src)).endCell(),
      );
    },
    parse: (src) => {
...
const PurchaseStone_types: ABIType[] = [
  ...
  {
    name: 'StonePurchasedNotification',
    header: 1,
    fields: [
      {
        name: 'user',
...
export class PurchaseStone implements Contract {
  ...
  async send(
    ...
    message: null | StonePurchase | Withdraw,
  ) {
